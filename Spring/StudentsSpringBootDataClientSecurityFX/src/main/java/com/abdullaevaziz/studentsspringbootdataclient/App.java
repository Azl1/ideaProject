package com.abdullaevaziz.studentsspringbootdataclient;
...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        String loginUser = preferences.get(Constants.PREFERENCE_KEY_LOGIN, null);
        System.out.println(loginUser);
        String res;
        if (loginUser != null) {
            res = "main.fxml";
        } else {
            res = "authorization.fxml";
        }
    ...
    public static void main(String[] args) {
        //TODO все преференсы очисти сейчас тут
