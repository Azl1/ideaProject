...
public class UserServiceImpl implements UserService {
    ...
    public List<User> getAllByOrOrderByFirstNameAsc() {
        return this.userRepository.findAllByOrderByFirstNameAsc();
    }
    @Override
    public List<User> getAllByOrOrderByFirstNamDesc() {
        return this.userRepository.findAllByOrderByFirstNameDesc();
    }
}
