...
public class CircleRepository {
    ...
    public CircleRepository() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .client(client)
                .build();
        this.service = retrofit.create(CircleService.class);
    }
    ...
    public List<Circle> getAll() throws IOException {
        retrofit2.Response<ResponseResult<List<Circle>>> execute = service.getAll().execute();
