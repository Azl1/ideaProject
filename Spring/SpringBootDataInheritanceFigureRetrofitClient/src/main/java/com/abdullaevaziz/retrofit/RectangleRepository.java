...
public class RectangleRepository {
    ...
    public RectangleRepository() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .client(client)
                .build();
        this.service = retrofit.create(RectangleService.class);
    }
    ...
    public List<Rectangle> getAll() throws IOException {
        retrofit2.Response<ResponseResult<List<Rectangle>>> execute = service.getAll().execute();
