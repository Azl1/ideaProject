...
public class StudentRepository {
    ...
    public Student post(Student student) throws IOException {
        Response<ResponseResult<Student>> execute = this.service.post(student).execute();
        return getData(execute);
    }

    public List<Student> getAll() throws IOException {
        Response<ResponseResult<List<Student>>> execute = service.getAll().execute();
        return getData(execute);
    }
    ...
    public Student delete(long id) throws IOException {
        Response<ResponseResult<Student>> execute = service.delete(id).execute();
        return getData(execute);
    }

    public List<Student> delete(String name) throws IOException {
        Response<ResponseResult<List<Student>>> execute = service.delete(name).execute();
        return getData(execute);
    }
