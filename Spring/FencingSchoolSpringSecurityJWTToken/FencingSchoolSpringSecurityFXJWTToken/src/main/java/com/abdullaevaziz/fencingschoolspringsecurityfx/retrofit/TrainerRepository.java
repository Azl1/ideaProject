...
public class TrainerRepository {
    ...
    public String authenticate(String username, String password) throws IOException {
        retrofit2.Response<ResponseResult<String>> execute = trainerService.authenticate(username, password).execute();
        return getData(execute);
    }

    public String getTokenUserName(String token) throws IOException {
        retrofit2.Response<ResponseResult<String>> execute = trainerService.getTokenUserName(token).execute();
        return getData(execute);
    }
}
