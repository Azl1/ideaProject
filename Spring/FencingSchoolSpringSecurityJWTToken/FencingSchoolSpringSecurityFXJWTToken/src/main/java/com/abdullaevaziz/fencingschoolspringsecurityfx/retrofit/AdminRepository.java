...
public class AdminRepository {
    ...
    public String authenticate(String username, String password) throws IOException {
        retrofit2.Response<ResponseResult<String>> execute = adminService.authenticate(username, password).execute();
        return getData(execute);
    }

    public String getTokenUserName(String token) throws IOException {
        retrofit2.Response<ResponseResult<String>> execute = adminService.getTokenUserName(token).execute();
        return getData(execute);
    }
}
