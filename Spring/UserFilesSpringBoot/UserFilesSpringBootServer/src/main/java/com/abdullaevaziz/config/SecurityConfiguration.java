...
import com.abdullaevaziz.security.JwtUserDetailsService;
import com.abdullaevaziz.security.jwt.JwtConfigurer;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.POST, "/userFile/**").authenticated()
