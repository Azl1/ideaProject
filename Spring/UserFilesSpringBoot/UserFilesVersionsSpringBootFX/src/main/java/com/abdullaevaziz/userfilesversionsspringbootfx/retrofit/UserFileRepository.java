...
import com.abdullaevaziz.userfilesversionsspringbootfx.security.JwtAuthInterceptor;
...
public class UserFileRepository {
    ...
    public List<UserFile> getAllVersion(String version) throws IOException {
        retrofit2.Response<ResponseResult<List<UserFile>>> execute = userFileService.listVersion(version).execute();
        return getData(execute);
    }
    ...
    public void downloadZip(String filename, File file) throws IOException {
        Call<ResponseBody> call = this.userFileService.downloadZipFile(filename);
    ...
    public void downloadZipList(File file) throws IOException {
        Call<ResponseBody> call = this.userFileService.downloadZipFileList();
    ...
    public void downloadFileAndVersion(File file, Integer version) throws IOException {
        Call<ResponseBody> call = this.userFileService.getFileNameAndVersion(file.getName(), version);
