...
import com.kirillkotov.service.TelegramService;
...
public class TelegramController {
    ...
    public void sendAudio(@PathVariable long chatId, @RequestPart MultipartFile file) {
        this.telegramService.sendAudio(chatId, file);
    }
