package com.abdullaevaziz.cardfxspring;
...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        String res;
        //TODO из преференсов получить айдишник юзера дефолтное значение взять -1
        long idUser = preferences.getLong(Constants.PREFERENCE_USER_ID, -1);
        //TODO если айди не -1 то в переменную рес записать "main.fxml"
        if (idUser != -1) {
            res = "main.fxml";

            //TODO иначе "auth.fxml"
        } else {
            res = "auth.fxml";
        }
