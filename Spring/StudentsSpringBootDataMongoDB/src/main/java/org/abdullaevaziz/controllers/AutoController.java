...
public class AutoController {
    ...
    public ResponseEntity<ResponseResult<Auto>> add(@RequestBody Auto auto, @PathVariable String studentId) {
        try {
    ...
    @GetMapping(path = "/{id}")
    public ResponseEntity<ResponseResult<Auto>> get(@PathVariable String id) {
        try {
   ...
   /* @GetMapping(path = "/student/{idStudent}")
    ...
    public ResponseEntity<ResponseResult<Auto>> delete(@PathVariable String id) {
        try {
