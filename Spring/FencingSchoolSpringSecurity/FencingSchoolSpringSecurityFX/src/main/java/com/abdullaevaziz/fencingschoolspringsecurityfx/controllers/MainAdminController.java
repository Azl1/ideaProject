...
public class MainAdminController {
    ...
    public void initialize() throws IOException {
        ...
        try {
            this.listAdmin.setItems(FXCollections.observableList(new AdminRepository(login, password).getAll()));
            ...
            this.listTrainers.setItems(FXCollections.observableList(new TrainerRepository(login, password).getAll()));
            ...
            this.listApprentice.setItems(FXCollections.observableList(new ApprenticeRepository(login, password).getAll()));
    ...
    public void buttonRemoveAdmin(ActionEvent actionEvent) {
        ...
        try {
            ...
            if (id == selectedAdmin.getId()) {
                preferences.put(Constants.PREFERENCE_KEY_LOGIN, selectedAdmin.getLogin());
                preferences.put(Constants.PREFERENCE_KEY_PASSWORD, selectedAdmin.getPassword());
