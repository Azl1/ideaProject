package com.abdullaevaziz.combobox;

import com.abdullaevaziz.controllers.ControllerData;
...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        Scene scene = new Scene(fxmlLoader.load(), 692, 385);
    ...
    public static void main(String[] args) {
        /*try {
            *//*Json2PojoGenerator generator = new Json2PojoGenerator("user1.json","src/main/java/");
            generator.generate("User", "com.abdullaevaziz.model");*//*
