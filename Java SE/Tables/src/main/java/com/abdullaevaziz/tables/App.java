package com.abdullaevaziz.tables;

import com.abdullaevaziz.tables.controllers.ControllerData;
...
public class App extends Application {
    ...
    public static void main(String[] args) {
        ...
        /*try {
            Json2PojoGenerator generator = new Json2PojoGenerator("send.json",
                    "src/main/java/");
            generator.generate("User", "com.abdullaevaziz.modelsJson");
