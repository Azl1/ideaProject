package com.abdullaevaziz.quiz;

import com.abdullaevaziz.quiz.controllers.ControllerData;
import com.abdullaevaziz.quiz.repository.Repository;
import com.abdullaevaziz.quiz.util.Json2PojoGenerator;
...
public class App extends Application {
    ...
    public static void main(String[] args) throws IOException {
       /* try {
           Json2PojoGenerator generator = new Json2PojoGenerator("response_code1.json","src/main/java/");
           generator.generate("QuizResult", "com.abdullaevaziz.quiz.model");
            Repository repository1 =
            new Repository("https://opentdb.com/api.php?amount=10&category=21&difficulty=medium");
