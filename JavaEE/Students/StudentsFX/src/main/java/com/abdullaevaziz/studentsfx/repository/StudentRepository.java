...
public class StudentRepository {
    ...
    public ArrayList<Student> get() throws IOException {
        try (InputStream inputStream = getData(Constants.SERVER_URL + "/student", "GET")) {
            ResponseResult<ArrayList<Student>> studentResponseResult = objectMapper.readValue(inputStream,
                    new TypeReference<>() {
            });
            return studentResponseResult.getData();
        }
    ...
    public Student delete(int id) throws IOException{
        try (InputStream inputStream = getData(Constants.SERVER_URL + "/student" + "?id=" + id, "DELETE")) {
            ResponseResult<Student> studentResponseResult = objectMapper.readValue(inputStream,
                    new TypeReference<>() {
            });
            return studentResponseResult.getData();
