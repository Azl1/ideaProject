package com.abdullaevaziz.userfilesservletsfx.client;
...
public class HttpMultipart {
     ...
     * @throws IOException
     */
    public HttpMultipart(String requestURL, String charset, Map<String, String> headers) throws IOException {
    ...
    public void addFilePart(String fieldName, File uploadFile)
        ...
        writer.append("Content-Type: charset=utf-8" + URLConnection.guessContentTypeFromName(fileName)).append(LINE);
    ...
    public String finish() throws IOException {
        ...
        if (status == HttpURLConnection.HTTP_OK) {
            ...
            try(BufferedReader errorStream = new BufferedReader(new InputStreamReader(httpConn.getErrorStream()))) {
                throw new IOException("Server returned non-OK status: " + status + " " + errorStream.readLine());
            }
        }
        return response;
    }

    public static void getMultiPart(String urlStr, String fileOutPath) throws IOException {
